  ...
  <section class="auth-shell bounce-in">
    ...
    <article class="card auth-card p-4">
      ...
      <div class="mt-2 grid grid-cols-2 gap-2">
        <Button block round plain type="primary" @click="router.push({ name: 'register' })"
          >注册账号</Button
        >
    ...
    <article class="card auth-tip mt-3 p-3 soft-yellow">
      <p>
        <i class="fa-regular fa-lightbulb mr-1 text-amber-500" />登录方式：账号 + 密码 +
        图形验证码。界面采用软萌相机风格，与应用整体主题保持一致。
      </p>
    </article>
  </section>
</template>
